...
-- CreateIndex
CREATE UNIQUE INDEX "library_linked_dir_id_key" ON "library"("linked_dir_id");

-- CreateIndex
CREATE INDEX "directory_library_id_parent_id_idx" ON "directory"("library_id", "parent_id");
...
-- AddForeignKey
ALTER TABLE "library" ADD CONSTRAINT "library_linked_dir_id_fkey" FOREIGN KEY ("linked_dir_id") REFERENCES "directory"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "directory" ADD CONSTRAINT "directory_library_id_fkey" FOREIGN KEY ("library_id") REFERENCES "library"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "directory" ADD CONSTRAINT "directory_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "directory"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "file" ADD CONSTRAINT "file_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "directory"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
